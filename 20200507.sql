...
rager테이블을 다음과 같은 칼럼으로 생성
ranger_no 컬럼은 NUMBER 타입으로 
ranger_nm 컬럼은 VARCHAR(50) 타입으로
reg_dt 컬럼은 DATE타입으로 (단 기본값은 입력당시의 서버의 현재 시간)
...
PRIMARY KEY 제약 : pk_테이블명
UNIQUE 제약 : u_테이블명
FOREIGN KEY 제약 : fk_테이블명_참조테이블명
